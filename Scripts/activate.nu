...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Guilh\PycharmProjects\workspace-python\objDetection'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Guilh\PycharmProjects\workspace-python\objDetection\Scripts\deactivate.nu'
